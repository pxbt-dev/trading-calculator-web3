...
Web3 version of trading-calculator-web allowing users to connect Bitcoin, Ethereum or Solana wallet to pre-fill values - // WIP

## 📋 Project Status
- **Backend**: 🚧 Simple wallet querying features implemented (please see examples below) along with trading calcualtor
- **Frontend**: 🚧 Implemented with manual wallet input that fetches wallet balance with RPC call, and pre-populates account size value.
